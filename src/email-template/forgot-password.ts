                    ...
                    <td align='left' valign='center'>
                        <div
                            ...
                            <table style='padding-bottom: 30px;'>
                                <tbody>
                                    <tr>
                                        <td> We received a request to reset the password for your account. To reset your
                                            password, click on the button below.</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table align='center' width='135' cellpadding='0' cellspacing='0' border='0'>
                                <tbody>
                                    <tr>
                                        <td style='padding: 0 4px 0 4px'>
                                            <a style='text-decoration:none' href='##reset_link##' target='_blank'>
                                                <table border='0' cellpadding='0' cellspacing='0'
                                                    style='border-spacing:0;color:#ffffff;border-radius:3px;background-color:#10174F;display:inline-table'>
                                                    <tbody>
                                                        <tr>
                                                            <td style='font-size:14px;font-weight:600;padding:0;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;text-align:center;cursor: pointer;'
                                                                valign='middle'>
                                                                Reset&nbsp;Password
                                                            </td>
                                                        </tr>
